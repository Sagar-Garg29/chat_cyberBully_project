...
function SideBar() {
  ...
  return (
    <div
      className={`bg-[#10b981]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${
        ...
        {filteredUsers.map((user, index) => (
          ...
          >
            ...
            {unseenMessages[user._id] > 0 && (
              <p className="absolute top-4 right-4 text-xs h-5 w-5 flex justify-center items-center rounded-full bg-emerald-500/50">
